...
@Composable
fun UserListScreen(onNext:(User)->Unit) {
    ...
    val userModel: UserViewModel = viewModel(factory = factory)
    val colors = listOf(Color(0xFFBBDEFB), Color(0xFFC8E6C9), Color(0xFFFFF9C4), Color(0xFFFFCCBC))
